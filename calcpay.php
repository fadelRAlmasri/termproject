                    ...
                    <form action="" method="post" id="form" >
                        <div class="card" style="width: 18rem; background-color:silver">
                            ...
                            <div class="card-body" style="direction: rtl;">
                                <h5 class="card-title" >              حساب فواتير الشراء </h5>
...
if(isset($_POST['send'])){
    ...
    $sql = "SELECT  sum(billcost)FROM baybill WHERE dt between '{$from_date}' and '{$to_date}'";
    $result = $con->query($sql);
    if ($result->num_rows > 0) {
        while($row = $result->fetch_assoc()) {
            echo"<h4 style='text-align:center;margin-right:4%; color:red'>".$row['sum(billcost)']."مجموع الفواتير هو </h4>";
        }
    }
