                ...
                <form action="" method="post" id="form" >
                    <div class="card" style="width: 18rem; background-color:silver">
                        ...
                        <div class="card-body" style="direction: rtl;">
                            ...
                            <p class="card-text"><input type="text" name="name" id=""required placeholder="اسم الصنف"  style="width: 100%; "></p>
...
if(isset($_POST['send'])){
    $name=$_POST['name'];
    $sql=$con->prepare("INSERT INTO class (name)VALUES ('$name') ");
    if($sql->execute()){
        echo "";
    }    
}
